...
extension HSBColorPickerDelegate {
  func HSBColorPickerFinishedDrawing() {}
}
...
class HSBColorPicker: UIView {
  ...
  override func draw(_ rect: CGRect) {
    ...
    self.delegate?.HSBColorPickerFinishedDrawing(sender: self, rect: rect)
  }
  ...
  @objc func touchedColor(gestureRecognizer: UILongPressGestureRecognizer) {
    ...
    self.delegate?.HSBColorPickerTouched(sender: self, color: color, point: point, state: gestureRecognizer.state)
  }
}
